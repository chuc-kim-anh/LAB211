# LAB211 - Java OOP Lab Projects

This repository contains a collection of Java Object-Oriented Programming (OOP) lab exercises completed during the LAB211 course. The projects are structured using clean code principles, the Model-View-Controller (MVC) architectural pattern, and standard Java collections.
...
*   **Key Features**:
    ...
    *   View all current active orders grouped by customer name.
...
*   **Build Tools**: Maven / NetBeans Project Configs.
...
2.  Clone the repository:
    ...
    ```
3.  Open any project folder in your favorite IDE (IntelliJ IDEA, Eclipse, or NetBeans).
4.  Run the `Main.java` class inside the `src/` directory of the corresponding project.
